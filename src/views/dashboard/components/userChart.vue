        ...
        <el-card :bordered="false" dis-hover>
          <div slot="header">
            <div class="acea-row row-middle">
              ...
              <span class="ivu-pl-8">运营数据</span>
            </div>
          </div>
          <div class="cardContainer">
            <operation-data ref="operationData"/>
          </div>
        </el-card>
      </el-col>
      <el-col :xl="8" :lg="12" :md="24" :sm="24" :xs="24">
        <el-card :bordered="false" dis-hover class="dashboard-green">
          <div slot="header">
            <div class="acea-row row-middle">
              <el-avatar icon="el-icon-picture-outline-round" size="small" style="color:#1890ff;background:#e6f7ff;font-size: 13px" />
              <span class="ivu-pl-8">企业绿度</span>
            </div>
          </div>
          <div class="cardContainer">
            <green-degree ref="greenDegree"/>
          </div>
        </el-card>
      </el-col>
    </el-row>
